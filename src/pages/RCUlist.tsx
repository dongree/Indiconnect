        ...
        <div>
            <div>
                ...
                <div className='buttons' style={{ display: 'flex', justifyContent: 'center' }}>
                    <Link to='/applist'>
                    <button style={{ width: '165px', height: '42px', borderRadius: '3px', backgroundColor: '#e1e3e7', boxShadow: '0px 0px 4px rgba(42, 45, 55, 0.1', border: 'none', fontWeight: '600', color: '#b0b2b8' }}>요청 온 뮤지션 1</button>
                    </Link>
                    <button style={{ width: '165px', height: '42px', borderRadius: '3px', backgroundColor: 'white', boxShadow: '0px 0px 4px rgba(42, 45, 55, 0.1', border: 'none', fontWeight: '600' }}>모집된 뮤지션 2</button>
                </div>
